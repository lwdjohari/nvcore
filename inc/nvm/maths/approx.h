 ...
 *
 * The Approx class provides a way to compare floating-point values with a certain tolerance.
 * It is useful when exact equality is not required and a small difference is acceptable.
 *
...
public:
     ...
     * @return true if the difference between lhs and rhs.value_ is less than rhs.epsilon_, false otherwise.
     */
     ...
     * @return true if the difference between lhs.value_ and rhs is less than lhs.epsilon_, false otherwise.
     */
