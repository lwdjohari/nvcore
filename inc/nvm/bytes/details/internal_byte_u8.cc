...
void EncodeAsciiString(const std::string& value, uint8_t* buffer,
...
int8_t DecodeInt8(const uint8_t* buffer, size_t size,
                         ByteOpResult& err) {
  if (!buffer) {
    err = ByteOpResult::Nullptr;
    return 0;
...
int16_t DecodeInt16(const uint8_t* buffer, size_t size,
                           ByteOpResult& err, bool is_big_endian) {
  if (!buffer) {
    err = ByteOpResult::Nullptr;
    return 0;
...
int32_t DecodeInt32(const uint8_t* buffer, size_t size,
                           ByteOpResult& err, bool is_big_endian) {
  if (!buffer) {
    err = ByteOpResult::Nullptr;
    return 0;
...
int64_t DecodeInt64(const uint8_t* buffer, size_t size,
                           ByteOpResult& err, bool is_big_endian) {
  if (!buffer) {
    err = ByteOpResult::Nullptr;
    return 0;
...
uint8_t DecodeUInt8(const uint8_t* buffer, size_t size,
                           ByteOpResult& err) {
  if (!buffer) {
    err = ByteOpResult::Nullptr;
    return 0;
...
uint16_t DecodeUInt16(const uint8_t* buffer, size_t size,
                             ByteOpResult& err, bool is_big_endian) {
  if (!buffer) {
    err = ByteOpResult::Nullptr;
    return 0;
...
uint32_t DecodeUInt32(const uint8_t* buffer, size_t size,
                             ByteOpResult& err, bool is_big_endian) {
  if (!buffer) {
    err = ByteOpResult::Nullptr;
    return 0;
...
uint64_t DecodeUInt64(const uint8_t* buffer, size_t size,
                             ByteOpResult& err, bool is_big_endian) {
  if (!buffer) {
    err = ByteOpResult::Nullptr;
    return 0;
...
double DecodeDouble(const uint8_t* buffer, size_t size,
                           ByteOpResult& err, bool is_big_endian) {
  if (!buffer) {
    err = ByteOpResult::Nullptr;
    return 0.0;
